...
class FusionCAM(BaseCAM):
    ...
    """
    Fusion-CAM : Fuses gradient and region based cams to enhance localization 
    and highlight complementary features.
    ...
    def __init__(
        ...
        **cam_kwargs,
        ...
        Args:
            ...
            cam_kwargs: Extra arguments passed to CAM constructors.
        """
