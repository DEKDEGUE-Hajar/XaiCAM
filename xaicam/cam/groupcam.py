...
class GroupCAM(BaseCAM):
    ...
    Groups feature maps and evaluates their joint contribution
    to the target class for more stable and structured explanations.

    Reference:
        Zhang et al., Understanding Deep Neural Networks via
        Group-wise Feature Importance. ICCV 2021.
