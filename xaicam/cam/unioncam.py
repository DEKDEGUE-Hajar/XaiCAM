...
class UnionCAM(BaseCAM):
    """
    UnionCAM: enhancing CNN interpretability through denoising, weighted fusion, and selective high-quality class activation
    Reference:
        Hu et al., UnionCAM: enhancing CNN interpretability through denoising, weighted fusion, and selective high-quality class activation
    ...
    def forward(self, x, class_idx=None, theta=10):
        ...
        #print(f"Union-CAM selected: {selected_method} " f"(β_de_region: {β_de_region:.5f}, β_region: {β_region:.5f})")
